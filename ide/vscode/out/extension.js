...
function activate(context) {
    ...
    const walkthroughCommentCommand = vscode.commands.registerCommand('symposium.addWalkthroughComment', (reply) => walkthroughProvider.handleCommentSubmission(reply));
    ...
    const reviewActionCommand = vscode.commands.registerCommand('symposium.reviewAction', (action) => {
...
async function findQChatTerminal(bus) {
    ...
    if (aiEnabledTerminals.length > 1) {
        ...
        const lastSelectedPID = context.workspaceState.get('symposium.lastSelectedTerminalPID');
